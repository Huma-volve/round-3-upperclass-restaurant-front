...
const Sidebar: React.FC<sildebarProps> = ({  title, subtitle ,background}) => {
    ...
    return (
        <aside className="bg-black h-screen p-8 grid grid-rows-[auto_1fr_auto] " style={{ backgroundImage: `url(${background})`, backgroundSize: 'cover' , backgroundPosition: 'center'    }}>
            ...
            <div className="mainsec text-white flex items-center justify-center">
                <div>
                    <p className="font-bitter text-6xl font-normal text-center text-text_primary">{title}</p>
